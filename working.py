...
def re_stitch():
    ...
    print('Done Stitching Colored Tiles')


def make_histogram():
    fig = plt.figure()
    plt.hist(tile_area_list, bins=50)
